...
public static class Helpers
{
    ...
    // Метод для разделения списка/массива на несколько списков/массивов с указанным размером
    // Method for splitting a list/array into several lists/arrays with a specified size
